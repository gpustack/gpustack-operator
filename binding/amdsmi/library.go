...
// device, STATUS_NOT_SUPPORTED above all.
func (r Return) IsAPIUnavailable() bool {
	switch r {
	case STATUS_LIBRARY_NOT_FOUND, STATUS_FUNCTION_NOT_FOUND,
		STATUS_FAIL_LOAD_MODULE, STATUS_FAIL_LOAD_SYMBOL,
		STATUS_DRIVER_NOT_LOADED, STATUS_NO_DRV, STATUS_NOT_YET_IMPLEMENTED:
		return true
	}
	return false
}
