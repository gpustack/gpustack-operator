 ...
 */
typedef struct {
    unsigned int virtCap;       //!< This field indicates the virtualization capability of a device (whether a device supports to be
                                    //!< virtualized) : 0 indicates non-virtualizable and 1 indicates virtualizable. Refer to \ref MtmlVirtCapability.
    unsigned int virtRole;      //!< This field indicates the role that this device is playing in a virtualization-supported
                                    //!< environment. Refer to \ref MtmlVirtRole.
    unsigned int mpcCap;        //!< This field indicates whether this device has MPC capability.
                                    //!< 0 indicates not having MPC capability, and 1 indicates having MPC capability. Refer to \ref MtmlMpcCapability.
    unsigned int mpcType;       //!< This field indicates this device's MPC type.
                                    //!< 0 indicates non-MPC type, 1 indicates MPC parent type, and 2 indicates MPC instance type. Refer to \ref MtmlMpcType.
    unsigned int mtLinkCap;     //!< This field indicates whether this device has MtLink capability.
    ...
    unsigned int rsvd;         //!< Reserved for future extension.
    unsigned int rsvd2;        //!< Reserved for future extension.
} MtmlDeviceProperty;
