 ...
 */
CNDEV_EXPORT cndevRet_t cndevInit(__int32_t reserved);
 ...
 * - ::CNDEV_ERROR_UNKNOWN
 */
CNDEV_EXPORT cndevRet_t cndevRelease(void);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevGetLastError(void);
 ...
 */
CNDEV_EXPORT const char *cndevGetErrorString(cndevRet_t errorId);
 ...
 * - ::CNDEV_ERROR_NO_DEVICES
 */
CNDEV_EXPORT cndevRet_t cndevGetDriverVersion(__uint32_t *majorVersion, __uint32_t *minorVersion, __uint32_t *buildVersion);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevGetVersionInfo(cndevVersionInfo_t *versInfo, cndevDevice_t device);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevGetLibVersion(cndevLibVersionInfo_t *libVerInfo);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPCIeFirmwareVersion(cndevPCIeFirmwareVersion_t *version, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetLowestSupportDriverVersion(cndevVersionInfo_t *versInfo);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceCount(cndevCardInfo_t *cardNum);
 ...
 * - ::CNDEV_ERROR_INVALID_ARGUMENT
 */
CNDEV_EXPORT cndevRet_t cndevDeviceGetMinorNumber(__uint32_t *minor, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetMemoryUsageV2(cndevMemoryInfoV2_t *memInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetFrequencyInfo(cndevFrequencyInfo_t *freqInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetTemperatureInfo(cndevTemperatureInfo_t *tempInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetFanSpeedInfo(cndevFanSpeedInfo_t *fanInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetProcessInfo(__uint32_t *infoCount, cndevProcessInfo_t *procInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetCoreCount(cndevCardCoreCount_t *cardCoreCount, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetClusterCount(cndevCardClusterCount_t *clusCount, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetCardName(cndevCardName_t *cardName, cndevDevice_t device);
 ...
 */
CNDEV_EXPORT const char *cndevGetCardNameString(cndevNameEnum_t cardName);
 ...
 */
CNDEV_EXPORT const char *cndevGetCardNameStringByDevId(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetCardSN(cndevCardSN_t *cardSN, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetCardPartNumber(cndevCardPartNumber_t *cardPN, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetCardHealthState(cndevCardHealthState_t *cardHealthState, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_INVALID_DEVICE_ID
 */
CNDEV_EXPORT cndevRet_t cndevGetCardHealthStateV2(cndevCardHealthStateV2_t *cardHealthState, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetCardHeartbeatCount(cndevCardHeartbeatCount_t *cardHeartbeatCount, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetFastAlloc(cndevFastAlloc_t *fastalloc, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetCodecTurbo(cndevCodecTurbo_t *codecTurbo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetNUMANodeIdByDevId(cndevNUMANodeId_t *numaNodeId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetChassisInfoV2(cndevChassisInfoV2_t *chassisinfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetUUID(cndevUUID_t *uuidInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetCardVfState(cndevCardVfState_t *vfstate, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceOsMemoryUsageV2(cndevDeviceOsMemoryInfo_t *mem, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetChipId(cndevChipId_t *chipid, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetMLUFrequencyStatus(cndevMLUFrequencyStatus_t *status, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevUnlockMLUFrequency(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetCRCInfo(cndevCRCInfo_t *crcInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDDRInfo(cndevDDRInfo_t *ddrInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetOverTemperatureInfo(cndevOverTemperatureInfo_t *tempInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPerformanceThrottleReason(cndevPerformanceThrottleReason_t *reason, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetComputeMode(cndevComputeMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevSetComputeMode(cndevComputeMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceHandleByIndex(__int32_t index, cndevDevice_t *handle);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetDevIdByBDF(__int32_t version, cndevDevice_t *dev, __uint32_t domain, __uint32_t bus, __uint32_t device,
					__uint32_t function);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceHandleByPciBusId(const char *pciBusId, cndevDevice_t *handle);
 ...
 * - ::CNDEV_ERROR_NOT_FOUND
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceHandleBySerial(const char *sn, cndevDevice_t *handle);
 ...
 * - ::CNDEV_ERROR_NOT_FOUND
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceHandleByUUID(const char *uuid, cndevDevice_t *handle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetParityError(cndevParityError_t *error, cndevDevice_t handle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDockerParam(cndevDockerParam_t *param, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetBAR4MemoryInfo(cndevBAR4Memory_t *bar4Memory, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetComputeCapability(__uint32_t *major, __uint32_t *minor, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetApplicationsClock(cndevClockType_t clockType, __uint32_t *clockMHz, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevDeviceGetFieldValues(cndevDevice_t device, __int32_t valueCount, cndevFieldValue_t *value);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetVoltageInfo(cndevVoltageInfo_t *voltage, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetCurrentInfo(cndevCurrentInfo_t *current, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevResetDevice(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceCanPeerAble(bool *canPeerAble, cndevDevice_t deviceSrc, cndevDevice_t deviceDst);
 ...
 * - ::CNDEV_ERROR_NOT_FOUND
 */
CNDEV_EXPORT cndevRet_t cndevGetExportFunction(const char *name, const void **func);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetCurrentPCIInfo(cndevCurrentPCIInfo_t *currentPCIInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMaxPCIInfo(cndevPCIInfo_t *maxPCIInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNKNOWN
 */
CNDEV_EXPORT cndevRet_t cndevGetPCIeInfoV2(cndevPCIeInfoV2_t *deviceInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPCIethroughputV2(cndevPCIethroughputV2_t *pciethroughput, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNSUPPORTED_API_VERSION
 */
CNDEV_EXPORT cndevRet_t cndevGetLowestLinkSpeed(cndevLinkSpeed_t *linkspeed, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPcieReplayCounter(cndevPcieReplayCounter_t *count, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceAffinity(cndevAffinity_t *affinity, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevClearCurrentThreadAffinity(__int32_t version, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevSetCurrentThreadAffinity(__int32_t version, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevTopologyGetRelationship(cndevTopologyRelationship_t *relationship, cndevDevice_t device1, cndevDevice_t device2);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevTopologyGetNearestDevices(__int32_t version, cndevTopologyRelationshipEnum_t rel, __uint64_t *count,
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetNUMANodeIdByTopologyNode(cndevNUMANodeId_t *numaNodeId, cndevTopologyNode_t *treeNode);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevTopologyGetCpuRelatedDevices(__int32_t version, __int32_t cpuId, __uint64_t *count, __uint64_t *deviceArray);
 ...
 * - ::CNDEV_ERROR_NOT_FOUND
 */
CNDEV_EXPORT cndevRet_t cndevTopologyGetRelationshipByNode(cndevTopologyRelationship_t *relationship, cndevTopologyNode_t *node1,
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetNodeByBDF(__int32_t version, cndevTopologyNode_t **treeNode, __uint32_t domain, __uint32_t bus,
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetNodeByDevId(__int32_t version, cndevTopologyNode_t **treeNode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevTopologyGetVirtualRootNode(__int32_t version, cndevTopologyNode_t **root);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevTopologyTraverseTree(__int32_t version, CNDEV_TRAVERSE_CALLBACK callback, void *userdata);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetNodeCapabilityInfo(cndevCapabilityInfo_t *capability, cndevTopologyNode_t *treeNode);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetNodeByDeviceName(__int32_t version, __int32_t *count, cndevTopologyNode_t *nodeArray, const char *deviceName);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkVersion(cndevMLULinkVersion_t *version, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkStatusV2(cndevMLULinkStatusV2_t *status, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetOpticalInfo(cndevOpticalInfo_t *optical, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkSpeedInfo(cndevMLULinkSpeed_t *speed, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkCapability(cndevMLULinkCapability_t *capability, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkCounter(cndevMLULinkCounter_t *count, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkCounterExt(cndevMLULinkCounterExt_t *count, cndevDevice_t device, __int32_t link);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevResetMLULinkCounter(cndevMLULinkSetCounter_t *setcount, cndevDevice_t device, __int32_t link);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevResetMLULinkAllCounters(cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkBasicCounter(cndevMLULinkBasicCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkCongestionCtrlCounter(cndevMLULinkCongestionCtrlCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkErrorCounter(cndevMLULinkErrorCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkFlowCtrlCounter(cndevMLULinkFlowCtrlCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkEventCounter(cndevMLULinkEventCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkTaskStatsCounter(cndevMLULinkTaskStatsCounter_t *counter, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevSetMLULinkState(cndevDevice_t device, __int32_t link, bool enable);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkState(__int32_t *ib_cmd_info, __int32_t *ob_cmd_info, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkRemoteInfo(cndevMLULinkRemoteInfo_t *remoteinfo, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRemoteHostMgmtAddr(cndevMLULinkMgmtAddr_t *mgmt_addr, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRemoteHostSN(cndevMLULinkHostSN_t *host_sn, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkPPI(cndevMLULinkPPI_t *ppi, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkOPN(cndevMLULinkOPN_t *opn, cndevDevice_t device, __int32_t link);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkDevSN(cndevMLULinkDevSN_t *devinfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_INVALID_LINK
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkPortMode(cndevMLULinkPortMode_t *mode, cndevDevice_t device, __int32_t port);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkOverRoCECtrl(cndevMLULinkOverRoCECtrl_t *ctrl, cndevDevice_t device, __int32_t port);
 ...
 */
CNDEV_EXPORT __int32_t cndevGetMLULinkPortNumber(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMLULinkPortIP(cndevMLULinkPortIP_t *ip, cndevDevice_t device, __int32_t port);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetECCInfo(cndevECCInfo_t *eccInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevSetEccMode(cndevEccMode_t *eccMode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetEccMode(cndevEccMode_t *currentMode, cndevEccMode_t *pendingMode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMemEccCounter(cndevMemEccCounter_t *eccCounter, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetSramEccHistogram(cndevSramEccHistogram_t *eccHistogram, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetRetiredPages(cndevRetiredPageInfo_t *retirepage, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetRetiredPagesStatus(cndevRetiredPageStatus_t *retirepagestatus, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRemappedRows(cndevRemappedRow_t *rows, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRemappedRowsV2(cndevRemappedRowV2_t *rows, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRepairStatus(cndevRepairStatus_t *status, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetAddressSwaps(cndevAddressSwap_t *swaps, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetAddressSwapsV2(cndevAddressSwapV2_t *swaps, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetRetiredPagesOperation(cndevRetiredPageOperation_t *operation, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceUtilizationInfo(cndevUtilizationInfo_t *utilInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetImageCodecUtilization(cndevImageCodecUtilization_t *jpuutil, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetVideoCodecUtilization(cndevVideoCodecUtilization_t *vpuutil, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetScalerUtilization(cndevScalerUtilization_t *scalerutil, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceCPUUtilizationV2(cndevDeviceCPUUtilizationV2_t *util, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceCPUSamplingInterval(cndevDeviceCPUSamplingInterval_t *time, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevSetDeviceCPUSamplingInterval(cndevDeviceCPUSamplingInterval_t *time, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetTinyCoreUtilization(cndevTinyCoreUtilization_t *util, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetProcessUtilization(__uint32_t *processCount, cndevProcessUtilization_t *processUtil, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetProcessUtilizationInfo(unsigned int *processCount, cndevProcessUtilizationInfo_t *processUtil, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NO_PERMISSION
 */
CNDEV_EXPORT cndevRet_t cndevSetPowerManagementLimitation(cndevPowerManagementLimitation_t *limitation, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPowerManagementLimitation(cndevPowerManagementLimitation_t *limitation, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPowerManagementDefaultLimitation(cndevPowerManagementLimitation_t *defaultLimitation, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetPowerManagementLimitationRange(cndevPowerManagementLimitationRange_t *limit, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDevicePowerInfo(cndevDevicePowerInfo_t *powerInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetMimMode(cndevMimMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NO_PERMISSION
 */
CNDEV_EXPORT cndevRet_t cndevSetMimMode(cndevMimMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetSRIOVMode(cndevSRIOVMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevSetSRIOVMode(cndevSRIOVMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateMluInstanceByProfileId(cndevMluInstance_t *miHandle, __uint32_t profileId, cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateMluInstanceByProfileName(cndevMluInstance_t *miHandle, char *profileName, cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateMluInstanceByProfileIdWithPlacement(cndevMluInstancePlacement_t *placement,
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateMluInstanceByProfileNameWithPlacement(cndevMluInstancePlacement_t *placement,
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDestroyMluInstanceByHandle(cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDestroyMluInstanceByInstanceName(cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceProfileInfo(cndevMluInstanceProfileInfo_t *profileInfo,
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstancePossiblePlacements(__int32_t *count, cndevMluInstancePlacement_t *placement,
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceRemainingCapacity(__int32_t *count, __int32_t profileId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMaxMluInstanceCount(__int32_t *count, __int32_t profileId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceInfo(cndevMluInstanceInfo_t *miInfo, cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetAllMluInstanceInfo(__int32_t *count, cndevMluInstanceInfo_t *miInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceByIndex(cndevMluInstance_t *miHandle, __int32_t index, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetDeviceHandleFromMluInstanceHandle(cndevDevice_t *devcieHanlde, cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstance(cndevMluInstance_t *miHandle,  __int32_t *count, __int32_t profileId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceId(__int32_t *instanceId, cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetMluInstanceById(cndevMluInstance_t *miHandle, __int32_t instanceId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetSMLUMode(cndevSMLUMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NO_PERMISSION
 */
CNDEV_EXPORT cndevRet_t cndevSetSMLUMode(cndevSMLUMode_t *mode, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetSMluProfileIdInfo(cndevSMluProfileIdInfo_t *profileId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetSMluProfileInfo(cndevSMluProfileInfo_t *profileInfo, __int32_t profile, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateSMluInstanceByProfileId(cndevMluInstance_t *miHandle, __uint32_t profileId, cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateSMluInstanceByProfileName(cndevMluInstance_t *miHandle, char *profileName, cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDestroySMluInstanceByHandle(cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDestroySMluInstanceByInstanceName(cndevDevice_t device, char *instanceName);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetSMluInstanceInfo(cndevSMluInfo_t *miInfo, cndevMluInstance_t miHandle);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevUpdateSMluInstanceQuotaByHandle(cndevMluInstance_t miHandle, cndevSMluSet_t *instance_quota);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevUpdateSMluInstanceQuotaByInstanceName(cndevDevice_t device, char *instanceName, cndevSMluSet_t *instance_quota);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevGetAllSMluInstanceInfo(__int32_t *count, cndevSMluInfo_t *miInfo, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevCreateSMluProfileInfo(cndevSMluSet_t *profileInfo, __int32_t *profileId, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDestroySMluProfileInfo(__int32_t profileId, cndevDevice_t device);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevDeviceSetConfigs(unsigned long long value, cndevDeviceConfigsTypeEnum_t type, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDeviceGetConfigs(unsigned long long *value, cndevDeviceConfigsTypeEnum_t type, cndevDevice_t device);
 ...
 * - the configuration and prevent the next call to this API from failing.
 */
CNDEV_EXPORT cndevRet_t cndevDeviceActiveConfigs(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevDeviceResetConfigs(cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_UNKNOWN
 */
CNDEV_EXPORT cndevRet_t cndevEventHandleCreate(cndevEventHandle *handle);
 ...
 * - ::CNDEV_ERROR_UNINITIALIZED,
 */
CNDEV_EXPORT cndevRet_t cndevEventHandleDestroy(cndevEventHandle handle);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevRegisterEvents(cndevEventHandle handle, unsigned long long eventTypes, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_TIMEOUT
 */
CNDEV_EXPORT cndevRet_t cndevEventWait(cndevEventHandle handle, cndevEventData_t *eventData, __int32_t timeout);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevGetSupportedEventTypes(unsigned long long *eventTypes, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_NOT_SUPPORTED
 */
CNDEV_EXPORT cndevRet_t cndevInjectEventError(__uint64_t eventError, cndevDevice_t device);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevMpmQueryDeviceSupport(cndevDevice_t device, bool *mpmSupport);
 ...
 * - ::CNDEV_ERROR_MALLOC
 */
CNDEV_EXPORT cndevRet_t cndevMpmSampleAlloc(cndevMpmSample_t *mpmSample);
 ...
 * - ::CNDEV_ERROR_INVALID_ARGUMENT
 */
CNDEV_EXPORT cndevRet_t cndevMpmSampleFree(cndevMpmSample_t mpmSample);
 ...
 * - ::CNDEV_ERROR_IN_PROBLEM
 */
CNDEV_EXPORT cndevRet_t cndevMpmSampleGet(cndevMpmSample_t mpmSample, cndevDevice_t device);
 ...
 */
CNDEV_EXPORT cndevRet_t cndevMpmMetricsGet(cndevMpmMetricsGet_t *metricsGet);
