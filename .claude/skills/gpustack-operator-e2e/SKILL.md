...
| 37 | Instance metrics subresource serves the current instance-scoped utilization | `pkg/worker/extensionapis/worker/**`, `pkg/devicemanager/**`, `pkg/utils/datax/snapshot.go`, `api/worker/v1/instance.metrics.go` | yes (confirm) | any (chain materialized) |
