...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1.Condition{}.OpenAPIModelName():                             schema_gpustackai_gpustack_api_v1_Condition(ref),
		v1.Setting{}.OpenAPIModelName():                               schema_gpustackai_gpustack_api_v1_Setting(ref),
		v1.SettingList{}.OpenAPIModelName():                           schema_gpustackai_gpustack_api_v1_SettingList(ref),
		v1.SettingSpec{}.OpenAPIModelName():                           schema_gpustackai_gpustack_api_v1_SettingSpec(ref),
		v1.SettingStatus{}.OpenAPIModelName():                         schema_gpustackai_gpustack_api_v1_SettingStatus(ref),
		v1.Status{}.OpenAPIModelName():                                schema_gpustackai_gpustack_api_v1_Status(ref),
...
func schema_gpustackai_gpustack_api_v1_Condition(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_gpustackai_gpustack_api_v1_Setting(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Setting is the schema for gpustack.ai.\n\nThe namespace is the system namespace, which means the Setting is system-scoped.\n\nUnderhood, a Setting is mapping to a key-value pair of a Kubernetes Secret, and the Setting's name is the same as the Secret's data key.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.SettingSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.SettingStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1.SettingSpec{}.OpenAPIModelName(), v1.SettingStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_gpustackai_gpustack_api_v1_SettingList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SettingList holds the list of Setting.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1.Setting{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.Setting{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_gpustackai_gpustack_api_v1_SettingSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"value": {
						SchemaProps: spec.SchemaProps{
							Description: "Value contains the configuration data, it is provided as a write-only input field.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_gpustackai_gpustack_api_v1_SettingStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SettingStatus defines the observed state of Setting.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description is the description of the settings.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"editable": {
						SchemaProps: spec.SchemaProps{
							Description: "Editable indicates whether the setting is editable on UI.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"sensitive": {
						SchemaProps: spec.SchemaProps{
							Description: "Sensitive indicates whether the setting is sensitive.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"value": {
						SchemaProps: spec.SchemaProps{
							Description: "Value is the current value of the setting, it is provided as a read-only output field.\n\n\"(sensitive)\" returns if the setting is sensitive.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"editable", "sensitive", "value"},
			},
		},
	}
}

func schema_gpustackai_gpustack_api_v1_Status(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Status includes phase, phase message and conditions.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
