...
type ClusterLister interface {
	...
	List(selector labels.Selector) (ret []*serverv1.Cluster, err error)
...
type clusterLister struct {
	listers.ResourceIndexer[*serverv1.Cluster]
}

// NewClusterLister returns a new ClusterLister.
func NewClusterLister(indexer cache.Indexer) ClusterLister {
	return &clusterLister{listers.New[*serverv1.Cluster](indexer, serverv1.Resource("cluster"))}
}

// Clusters returns an object that can list and get Clusters.
func (s *clusterLister) Clusters(namespace string) ClusterNamespaceLister {
	return clusterNamespaceLister{listers.NewNamespaced[*serverv1.Cluster](s.ResourceIndexer, namespace)}
}
...
type ClusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*serverv1.Cluster, error)
