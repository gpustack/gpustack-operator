...
type ProjectLister interface {
	...
	List(selector labels.Selector) (ret []*serverv1.Project, err error)
...
type projectLister struct {
	listers.ResourceIndexer[*serverv1.Project]
}

// NewProjectLister returns a new ProjectLister.
func NewProjectLister(indexer cache.Indexer) ProjectLister {
	return &projectLister{listers.New[*serverv1.Project](indexer, serverv1.Resource("project"))}
}

// Projects returns an object that can list and get Projects.
func (s *projectLister) Projects(namespace string) ProjectNamespaceLister {
	return projectNamespaceLister{listers.NewNamespaced[*serverv1.Project](s.ResourceIndexer, namespace)}
}
...
type ProjectNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*serverv1.Project, error)
