...
func NewInstanceTypeLister(indexer cache.Indexer) InstanceTypeLister {
	return &instanceTypeLister{listers.New[*workerv1alpha1.InstanceType](indexer, workerv1alpha1.Resource("instancetype"))}
}
