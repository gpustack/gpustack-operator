...
type InstanceTypeApplyConfiguration struct {
	...
	*metav1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                                 *v1alpha1.InstanceTypeSpecApplyConfiguration   `json:"spec,omitempty"`
	Status                               *v1alpha1.InstanceTypeStatusApplyConfiguration `json:"status,omitempty"`
}
...
func InstanceType(name string) *InstanceTypeApplyConfiguration {
	...
	b.WithName(name)
	b.WithKind("InstanceType")
	b.WithAPIVersion("worker.gpustack.ai/v1")
	return b
}

func (b InstanceTypeApplyConfiguration) IsApplyConfiguration() {}
...
func (b *InstanceTypeApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *InstanceTypeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InstanceTypeApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *InstanceTypeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InstanceTypeApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *InstanceTypeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *InstanceTypeApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *InstanceTypeApplyConfiguration) WithSpec(value *v1alpha1.InstanceTypeSpecApplyConfiguration) *InstanceTypeApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *InstanceTypeApplyConfiguration) WithStatus(value *v1alpha1.InstanceTypeStatusApplyConfiguration) *InstanceTypeApplyConfiguration {
	b.Status = value
	return b
}

// GetKind retrieves the value of the Kind field in the declarative configuration.
func (b *InstanceTypeApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *InstanceTypeApplyConfiguration) GetAPIVersion() *string {
...
func (b *InstanceTypeApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
