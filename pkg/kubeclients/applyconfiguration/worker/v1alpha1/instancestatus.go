...
type InstanceStatusApplyConfiguration struct {
	...
	HostIPs []v1.HostIPApplyConfiguration `json:"hostIPs,omitempty"`
	// PodIPs holds the IP addresses allocated to the Kubernetes Pod that related to the Instance.
	PodIPs []v1.PodIPApplyConfiguration `json:"podIPs,omitempty"`
	...
	Allocations []DevicesAllocationGroupApplyConfiguration `json:"allocations,omitempty"`
}
...
func (b *InstanceStatusApplyConfiguration) WithHostIPs(values ...*v1.HostIPApplyConfiguration) *InstanceStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *InstanceStatusApplyConfiguration) WithPodIPs(values ...*v1.PodIPApplyConfiguration) *InstanceStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *InstanceStatusApplyConfiguration) WithAllocations(values ...*DevicesAllocationGroupApplyConfiguration) *InstanceStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
