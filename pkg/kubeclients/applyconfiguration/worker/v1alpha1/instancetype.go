...
type InstanceTypeApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *InstanceTypeSpecApplyConfiguration   `json:"spec,omitempty"`
	Status                           *InstanceTypeStatusApplyConfiguration `json:"status,omitempty"`
}
...
func (b *InstanceTypeApplyConfiguration) WithSpec(value *InstanceTypeSpecApplyConfiguration) *InstanceTypeApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *InstanceTypeApplyConfiguration) WithStatus(value *InstanceTypeStatusApplyConfiguration) *InstanceTypeApplyConfiguration {
	b.Status = value
	return b
}
