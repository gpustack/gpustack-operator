...
func (b *ProvisioningRequestConfigApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *ProvisioningRequestConfigApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ProvisioningRequestConfigApplyConfiguration) GetAPIVersion() *string {
...
func (b *ProvisioningRequestConfigApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
