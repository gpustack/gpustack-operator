...
func (b *LocalQueueSpecApplyConfiguration) WithClusterQueue(value kueuev1beta2.ClusterQueueReference) *LocalQueueSpecApplyConfiguration {
...
func (b *LocalQueueSpecApplyConfiguration) WithStopPolicy(value kueuev1beta2.StopPolicy) *LocalQueueSpecApplyConfiguration {
	b.StopPolicy = &value
	return b
}
