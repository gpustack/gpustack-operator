...
func (b *ProvisioningRequestConfigSpecApplyConfiguration) WithParameters(entries map[string]kueuev1beta2.Parameter) *ProvisioningRequestConfigSpecApplyConfiguration {
	if b.Parameters == nil && len(entries) > 0 {
		b.Parameters = make(map[string]kueuev1beta2.Parameter, len(entries))
	}
...
func (b *ProvisioningRequestConfigSpecApplyConfiguration) WithPodSetMergePolicy(value kueuev1beta2.ProvisioningRequestConfigPodSetMergePolicy) *ProvisioningRequestConfigSpecApplyConfiguration {
