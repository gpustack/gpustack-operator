...
import (
	v1alpha1 "gpustack.ai/gpustack/pkg/kubeclients/applyconfiguration/server/v1alpha1"
...
type ClusterApplyConfiguration struct {
	...
	*metav1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                                 *v1alpha1.ClusterSpecApplyConfiguration   `json:"spec,omitempty"`
	Status                               *v1alpha1.ClusterStatusApplyConfiguration `json:"status,omitempty"`
}
...
func (b *ClusterApplyConfiguration) WithSpec(value *v1alpha1.ClusterSpecApplyConfiguration) *ClusterApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *ClusterApplyConfiguration) WithStatus(value *v1alpha1.ClusterStatusApplyConfiguration) *ClusterApplyConfiguration {
	b.Status = value
	return b
}
