...
type DeploymentInterface interface {
	...
	Apply(ctx context.Context, deployment *applyconfigurationextensionsv1beta1.DeploymentApplyConfiguration, opts v1.ApplyOptions) (result *extensionsv1beta1.Deployment, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, deployment *applyconfigurationextensionsv1beta1.DeploymentApplyConfiguration, opts v1.ApplyOptions) (result *extensionsv1beta1.Deployment, err error)
	...
	ApplyScale(ctx context.Context, deploymentName string, scale *applyconfigurationextensionsv1beta1.ScaleApplyConfiguration, opts v1.ApplyOptions) (*extensionsv1beta1.Scale, error)
...
type deployments struct {
	*gentype.ClientWithListAndApply[*extensionsv1beta1.Deployment, *extensionsv1beta1.DeploymentList, *applyconfigurationextensionsv1beta1.DeploymentApplyConfiguration]
}

// newDeployments returns a Deployments
func newDeployments(c *ExtensionsV1beta1Client, namespace string) *deployments {
	return &deployments{
		gentype.NewClientWithListAndApply[*extensionsv1beta1.Deployment, *extensionsv1beta1.DeploymentList, *applyconfigurationextensionsv1beta1.DeploymentApplyConfiguration](
			"deployments",
			c.RESTClient(),
...
func (c *deployments) ApplyScale(ctx context.Context, deploymentName string, scale *applyconfigurationextensionsv1beta1.ScaleApplyConfiguration, opts v1.ApplyOptions) (result *extensionsv1beta1.Scale, err error) {
	if scale == nil {
