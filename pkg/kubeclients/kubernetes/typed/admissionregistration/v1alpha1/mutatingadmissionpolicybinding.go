...
type MutatingAdmissionPolicyBindingInterface interface {
	...
	Apply(ctx context.Context, mutatingAdmissionPolicyBinding *applyconfigurationadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *admissionregistrationv1alpha1.MutatingAdmissionPolicyBinding, err error)
...
type mutatingAdmissionPolicyBindings struct {
	*gentype.ClientWithListAndApply[*admissionregistrationv1alpha1.MutatingAdmissionPolicyBinding, *admissionregistrationv1alpha1.MutatingAdmissionPolicyBindingList, *applyconfigurationadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingApplyConfiguration]
}
...
func newMutatingAdmissionPolicyBindings(c *AdmissionregistrationV1alpha1Client) *mutatingAdmissionPolicyBindings {
	return &mutatingAdmissionPolicyBindings{
		gentype.NewClientWithListAndApply[*admissionregistrationv1alpha1.MutatingAdmissionPolicyBinding, *admissionregistrationv1alpha1.MutatingAdmissionPolicyBindingList, *applyconfigurationadmissionregistrationv1alpha1.MutatingAdmissionPolicyBindingApplyConfiguration](
