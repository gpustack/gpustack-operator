...
type DeviceClassInterface interface {
	...
	Apply(ctx context.Context, deviceClass *applyconfigurationresourcev1beta1.DeviceClassApplyConfiguration, opts v1.ApplyOptions) (result *resourcev1beta1.DeviceClass, err error)
	DeviceClassExpansion
}

// deviceClasses implements DeviceClassInterface
type deviceClasses struct {
	*gentype.ClientWithListAndApply[*resourcev1beta1.DeviceClass, *resourcev1beta1.DeviceClassList, *applyconfigurationresourcev1beta1.DeviceClassApplyConfiguration]
}

// newDeviceClasses returns a DeviceClasses
func newDeviceClasses(c *ResourceV1beta1Client) *deviceClasses {
	return &deviceClasses{
		gentype.NewClientWithListAndApply[*resourcev1beta1.DeviceClass, *resourcev1beta1.DeviceClassList, *applyconfigurationresourcev1beta1.DeviceClassApplyConfiguration](
			"deviceclasses",
			c.RESTClient(),
