...
type VolumeAttributesClassInterface interface {
	...
	Apply(ctx context.Context, volumeAttributesClass *applyconfigurationstoragev1alpha1.VolumeAttributesClassApplyConfiguration, opts v1.ApplyOptions) (result *storagev1alpha1.VolumeAttributesClass, err error)
...
type volumeAttributesClasses struct {
	*gentype.ClientWithListAndApply[*storagev1alpha1.VolumeAttributesClass, *storagev1alpha1.VolumeAttributesClassList, *applyconfigurationstoragev1alpha1.VolumeAttributesClassApplyConfiguration]
}
...
func newVolumeAttributesClasses(c *StorageV1alpha1Client) *volumeAttributesClasses {
	return &volumeAttributesClasses{
		gentype.NewClientWithListAndApply[*storagev1alpha1.VolumeAttributesClass, *storagev1alpha1.VolumeAttributesClassList, *applyconfigurationstoragev1alpha1.VolumeAttributesClassApplyConfiguration](
