...
import (
	apiextensionsv1 "gpustack.ai/gpustack/pkg/kubeclients/applyconfiguration/apiextensions/v1"
	typedapiextensionsv1 "gpustack.ai/gpustack/pkg/kubeclients/kubernetes/typed/apiextensions/v1"
