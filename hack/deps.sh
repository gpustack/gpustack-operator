...
function chart_staging() {
  ...
  while read -r line; do
    ...
    cat <<EOF
https://github.com/kubernetes-sigs/kueue/releases/download/v0.18.9/kueue-0.18.9.tgz 0.18.9 ${charts_dir}/kueue
...
https://dsx-ai-factory.github.io/topograph/topograph-1.0.0.tgz 1.0.0 ${charts_dir}/topograph
EOF
  )
}
